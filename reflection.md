...
I used Copilot to generated the code to remove the negative value and make the data into lower case. Also I promt it with pandas and numpy to make it more suitable with this assignment. I notice that the code that came from Copilot is not easy to understand when compare to my own code. However, AI will be a part of our future, so it is not a bad time to start learning it.
